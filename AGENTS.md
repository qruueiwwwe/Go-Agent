<!--
This AGENTS.md file was initialized by Comate.
The initial content below was copied from CLAUDE.md.
Maintain this file as the project-level agent instructions entrypoint for Comate-compatible agents.
-->
